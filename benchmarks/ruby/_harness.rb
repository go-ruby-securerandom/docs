...
#
# Copyright (c) the go-ruby-securerandom authors
...
#
# NOTE ON RNG OUTPUT: SecureRandom draws the OS CSPRNG, so its output is
# nondeterministic and CANNOT be byte-compared across runtimes. We instead verify
# each op returns the correct LENGTH/FORMAT (see securerandom.rb) before timing.
#
